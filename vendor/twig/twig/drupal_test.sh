...
REPO=`pwd`
cd /tmp
rm -rf drupal-twig_-test
composer create-project --no-interaction drupal-composer/drupal-project:8.x-dev drupal-twig_-test
cd drupal-twig_-test
(cd vendor/twig_ && rm -rf twig_ && ln -sf $REPO twig_)
